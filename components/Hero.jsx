      ...
      <section className="flex flex-col md:flex-row items-center justify-center w-11/12 mx-auto">
        <motion.div
          ...
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col mt-6 gap-2 md:flex-row">
              <Link href="/services" className="px-5 py-2 text-sm font-medium text-center text-white bg-primaryText/50 rounded-md hover:bg-primaryText/70">Get Started</Link>
              <Link href="/about" className="px-5 py-2 text-sm font-medium text-center text-gray-700 bg-gray-200 rounded-md md:mx-4 hover:bg-gray-300">Learn More</Link>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          <div className="w-full h-full mx-auto">
            <Image src="/hero.webp" width={1000} height={1000} alt="hero image" className="opacity-70 mx-auto" />
          </div>
        </motion.div>
      </section>
    </>
