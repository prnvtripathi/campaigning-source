      ...
      <section className="flex flex-col md:flex-row items-center justify-center w-11/12 mx-auto">
        <motion.div
          ...
          <div className="max-w-2xl">
            <h2 className="text-3xl font-semibold text-gray-300 tracking-widest md:text-4xl">Make Your Startup a<br /><span className={`text-primaryText font-bold md:text-5xl ${satisfy.className}`}>Brand</span></h2>
        ...
        <motion.div
          ...
          <div className="w-full h-full mx-auto">
            <Image src="/hero.webp" width={1000} height={1000} alt="hero image" className="opacity-70 rounded  mx-auto" />
          </div>
        </motion.div>
      </section>
    </>
